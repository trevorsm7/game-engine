...
int IPathing::script_findPath(lua_State* L)
{
    ...
    const int x1 = int(luaL_checkinteger(L, 2));
    const int y1 = int(luaL_checkinteger(L, 3));
    const int x2 = int(luaL_checkinteger(L, 4));
    const int y2 = int(luaL_checkinteger(L, 5));
